...
> Answer: Because less data is processed than server-side, routing between views is generally faster. With client-side routing, the page will not refresh, the data is displayed when we ask for it.
